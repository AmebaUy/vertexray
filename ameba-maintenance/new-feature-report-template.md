# Reporte de Nueva Funcionalidad / Cambio
...
- **Estado del testing pre-deploy:** ✅ Realizado / ⚠️ Omitido a pedido del dev
  - *(Si fue omitido, indicar motivo y dejar como primer ítem prioritario en ⏭️ Próximos Pasos: verificación funcional de los cambios no testeados.)*
...
**Asunto:** Reporte de Nueva Funcionalidad / Cambio — [Mes Año]
